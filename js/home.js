	...
	(function testimonials() {
		...
		function buildRow(containerId, data) {
			...
			doubled.forEach(function (t, i) {
				...
				card.appendChild(el("div", { class: "review-stars", "aria-label": "5 out of 5 stars" }, [document.createTextNode("★★★★★")]));
		...
		var toggleBtn = document.getElementById("marquee-toggle");
		...
		if (toggleBtn && section) {
			toggleBtn.addEventListener("click", function () {
				...
				toggleBtn.setAttribute("aria-label", paused ? "Resume testimonial scrolling" : "Pause testimonial scrolling");
			});
		}
	})();
})();
